    ...
    public static function seedPlans(): void
    {
        $plans = [
            ...
            [
                ...
                'max_adspy' => 0, 'max_ai' => 0, 'max_offers' => 0, 'max_transcriptions' => 0, 'max_tts' => 0,
                'prices' => ['monthly' => 79, 'quarterly' => 159, 'semiannual' => 267, 'annual' => 468],
            ],
            [
                'id' => 'essencial', 'name' => 'Afiliado Pro', 'label' => '5 páginas, 2 domínios',
                'features' => ['clone', 'pressel', 'player', 'pixel', 'cookie', 'backredirect', 'editor', 'adspy', 'offers'],
                'max_pages' => 5, 'max_domains' => 2, 'sort' => 2,
                'max_adspy' => 30, 'max_ai' => 10, 'max_offers' => 30, 'max_transcriptions' => 10, 'max_tts' => 10,
                'prices' => ['monthly' => 119, 'quarterly' => 237, 'semiannual' => 402, 'annual' => 679],
            ],
            [
                'id' => 'master', 'name' => 'Master Elite', 'label' => 'Tudo ilimitado + integrações',
                'features' => ['clone', 'pressel', 'player', 'pixel', 'cookie', 'backredirect', 'integrations', 'quizz', 'editor', 'adspy', 'offers'],
                'max_pages' => -1, 'max_domains' => 10, 'sort' => 3,
                'max_adspy' => 300, 'max_ai' => 100, 'max_offers' => 300, 'max_transcriptions' => 100, 'max_tts' => 100,
            ...
            [
                ...
                'max_adspy' => -1, 'max_ai' => -1, 'max_offers' => -1, 'max_transcriptions' => -1, 'max_tts' => -1,
                'prices' => [],
            ],
        ];
