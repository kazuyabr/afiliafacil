...
class ImportJsonData
{
    ...
    public static function seedPlans(): void
    {
        $plans = [
            ...
            [
                'id' => 'master', 'name' => 'Master', 'label' => 'Tudo ilimitado + integrações',
