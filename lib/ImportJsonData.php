    ...
    public static function seedPlans(): void
    {
        $plans = [
            [
                ...
                'max_adspy' => 3, 'max_ai' => 3, 'max_offers' => 3, 'max_transcriptions' => 2, 'max_tts' => 2, 'max_agent' => 10,
                'prices' => [],
            ],
            [
                'id' => 'vsl', 'name' => 'VSL Start', 'label' => 'Páginas de VSL com delay',
                'features' => ['video', 'delay', 'clone'], 'max_pages' => 1, 'max_domains' => 1, 'sort' => 1,
                'max_adspy' => 0, 'max_ai' => 0, 'max_offers' => 0, 'max_transcriptions' => 0, 'max_tts' => 0, 'max_agent' => 0,
            ...
            [
                ...
                'max_adspy' => 30, 'max_ai' => 10, 'max_offers' => 30, 'max_transcriptions' => 10, 'max_tts' => 10, 'max_agent' => 100,
            ...
            [
                ...
                'max_adspy' => 300, 'max_ai' => 100, 'max_offers' => 300, 'max_transcriptions' => 100, 'max_tts' => 100, 'max_agent' => 500,
            ...
            [
                ...
                'max_adspy' => -1, 'max_ai' => -1, 'max_offers' => -1, 'max_transcriptions' => -1, 'max_tts' => -1, 'max_agent' => -1,
                'prices' => [],
            ],
        ];
