    ...
    public static function seedPlans(): void
    {
        $plans = [
            [
                ...
                'features' => ['clone', 'offers', 'adspy', 'agent'], 'max_pages' => 1, 'sort' => 0,
                'max_adspy' => 3, 'max_ai' => 3, 'max_offers' => 3, 'max_transcriptions' => 2, 'max_tts' => 2, 'max_agent' => 10, 'max_subagents' => 0,
                'prices' => [],
            ],
            [
                'id' => 'vsl', 'name' => 'VSL Start', 'label' => 'Páginas de VSL com delay',
                'features' => ['video', 'delay', 'clone'], 'max_pages' => 1, 'sort' => 1,
                'max_adspy' => 0, 'max_ai' => 0, 'max_offers' => 0, 'max_transcriptions' => 0, 'max_tts' => 0, 'max_agent' => 0, 'max_subagents' => 0,
                'prices' => ['monthly' => 79, 'quarterly' => 159, 'semiannual' => 267, 'annual' => 468],
            ],
            [
                'id' => 'essencial', 'name' => 'Afiliado Pro', 'label' => '5 páginas',
                'features' => ['clone', 'pressel', 'player', 'pixel', 'cookie', 'backredirect', 'editor', 'adspy', 'offers', 'agent'],
                'max_pages' => 5, 'sort' => 2,
                'max_adspy' => 30, 'max_ai' => 10, 'max_offers' => 30, 'max_transcriptions' => 10, 'max_tts' => 10, 'max_agent' => 100, 'max_subagents' => 2,
                'prices' => ['monthly' => 119, 'quarterly' => 237, 'semiannual' => 402, 'annual' => 679],
            ],
            [
                'id' => 'master', 'name' => 'Master Elite', 'label' => 'Tudo ilimitado + integrações',
                'features' => ['clone', 'pressel', 'player', 'pixel', 'cookie', 'backredirect', 'integrations', 'quizz', 'editor', 'adspy', 'offers', 'agent'],
                'max_pages' => -1, 'sort' => 3,
                'max_adspy' => 300, 'max_ai' => 100, 'max_offers' => 300, 'max_transcriptions' => 100, 'max_tts' => 100, 'max_agent' => 500, 'max_subagents' => 5,
            ...
            [
                ...
                'features' => ['clone', 'pressel', 'player', 'pixel', 'cookie', 'backredirect', 'integrations', 'quizz', 'editor', 'adspy', 'offers', 'agent'],
                'max_pages' => -1, 'sort' => 4,
                'max_adspy' => -1, 'max_ai' => -1, 'max_offers' => -1, 'max_transcriptions' => -1, 'max_tts' => -1, 'max_agent' => -1, 'max_subagents' => -1,
                'prices' => [],
            ],
        ];
        ...
        foreach ($plans as $plan) {
            \AfiliaFacil\Models\Plan::firstOrCreate(
                ...
                [
                    ...
                    'max_offers_views' => $plan['max_offers'],
                    'max_transcriptions' => $plan['max_transcriptions'],
                    'max_tts' => $plan['max_tts'],
                    'max_agent_messages' => $plan['max_agent'],
