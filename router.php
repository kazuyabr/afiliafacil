...
$routes = [
    ...
    '/cookies' => '/cookies.php',
    '/degustacao' => '/degustacao.php',
    '/proxy.php' => '/proxy.php',
    '/webhooks/stripe' => '/webhooks/stripe.php',
    '/cron/monitor.php' => '/cron/monitor.php',
    ...
    '/admin/videos.php' => '/admin/videos.php',
    ...
    '/admin/training.php' => '/admin/training.php',
    '/admin/feedback.php' => '/admin/feedback.php',
    '/admin/agent-monitor.php' => '/admin/agent-monitor.php',
    '/admin/api/export.php' => '/admin/api/export.php',
    '/admin/api/feedback.php' => '/admin/api/feedback.php',
    '/admin/api/agent-monitor.php' => '/admin/api/agent-monitor.php',
    '/admin/adspy.php' => '/admin/adspy.php',
    '/admin/ofertas.php' => '/admin/ofertas.php',
    '/admin/ai-settings.php' => '/admin/ai-settings.php',
    '/admin/transcribe.php' => '/admin/transcribe.php',
    '/admin/tts.php' => '/admin/tts.php',
    '/admin/agent.php' => '/admin/agent.php',
    ...
    '/admin/api/ofertas.php' => '/admin/api/ofertas.php',
